...
• קטלוג הרצאות — הרצאות בודדות (PDF + סרטון), סדנאות (PDF + סרטון)`
  },
  {
    ...
    content: `⚡ מבוסס על מילת קוד שמופיעה על השקופית האחרונה של כל הרצאה
...
ד"ר אדרי מוסיפה את מילת הקוד לשקופית האחרונה של כל הרצאה.

📋 שלוש דרכי כניסה:
• ברקוד גנרי קבוע (אחד לכולן): סורקים → הבוט מבקש מילת קוד → כותבים "סיכום אושר" → מקבלים סיכום
• ברקוד ייעודי להרצאה: סורקים → מקבלים סיכום ישירות
• בלי סריקה: כותבים בוואטסאפ "סיכום אושר" → מקבלים סיכום

📋 המשך המסלול:
שלב 1: PDF סיכום + קישור לבלוג — ללא איסוף פרטים קודם!
...
💡 הברקודים נמצאים בלוח הבקרה → כרטיס "ברקודים לפוסט הרצאה" (גנרי + ייעודי לכל הרצאה)`
  }
];
