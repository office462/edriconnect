...
📌 הברקודים של מסלול "פוסט הרצאה" נמצאים בלוח הבקרה → כרטיס "ברקודים לפוסט הרצאה": ברקוד גנרי קבוע אחד לכל ההרצאות, ובנוסף ברקוד ייעודי לכל הרצאה שמזריק את מילת הקוד שלה.`
      },
      {
        id: 'sc-how-edit',
...
מסלול פוסט הרצאה (מילת קוד):
כל הרצאה מקבלת מילת קוד שד"ר אדרי מוסיפה לשקופית האחרונה:
• אנטומיה של אושר → "סיכום אושר"
• מניעת שחיקה → "סיכום שחיקה"
• תזונה מונעת מחלות → "סיכום תזונה"
• אריכות ימים → "סיכום אריכות"
• בריאות בהתאמה נשית גיל המעבר → "סיכום גיל המעבר"
• בינה מלאכותית בבריאות → "סיכום בינה"

שלוש דרכי כניסה:
• ברקוד גנרי קבוע — הפונה סורק → הבוט מבקש מילת קוד → הפונה כותב "סיכום אושר" → מקבל סיכום
• ברקוד ייעודי להרצאה — הפונה סורק → מקבל סיכום ישירות
• מי שלא סרק — כותב בוואטסאפ "סיכום אושר" ומקבל סיכום
